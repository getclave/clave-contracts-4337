...
export interface ValidationHandlerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "entrypoint"
      | "isHook"
...
export interface ValidationHandler extends BaseContract {
  connect(runner?: ContractRunner | null): ValidationHandler;
