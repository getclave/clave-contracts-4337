...
export interface IInitableInterface extends Interface {
  getFunction(nameOrSignature: "disable" | "init"): FunctionFragment;
...
export interface IInitable extends BaseContract {
  connect(runner?: ContractRunner | null): IInitable;
  waitForDeployment(): Promise<this>;

  interface: IInitableInterface;
